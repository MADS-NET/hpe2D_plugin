...
# Generated by the command: plugin -t source -d ../hpe2D -i /Users/p4010/MADS
hpe2D # Hostname: Fram-IV.local # Current working directory:
/Users/p4010/Develop/plugin_hpe # Creation date: 2024-07-29T14:29:07.609+0200 #
...
class Hpe2dPlugin : public Source<json> {
...
public:
  ...
  void set_params(void const *params) override {
    ...
    _params["device"] = 0;
    _params["model_file"] = "models/human-pose-estimation-0001.xml";
    _params["out_res"] = "800x600";
    _params.merge_patch(*(json *)params);

    _device = _params["device"];
    _model_file = _params["model_file"];
    out_res = _params["out_res"];
  ...
  map<string, string> info() override {
    return {{"device", to_string(_device)},
...
*/
INSTALL_SOURCE_DRIVER(Hpe2dPlugin, json)
